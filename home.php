...
<div class="wrapper">
    ...
    <section id="games">
        <h3>Interactive Alphabet Games</h3>
        <p>Choose from various games to enhance your child's learning experience.</p>
        <!-- Add links or buttons to interactive games -->
    </section>
    

    <section id="songs">
        <h3>Alphabet Songs and Videos</h3>
        <p>Enjoy catchy and animated songs to memorize the alphabet.</p>
        <!-- Add thumbnails or links to alphabet songs -->
    </section>
